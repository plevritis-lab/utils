...
class CellProportionWidget(QWidget):
    ...
    def update_plot(self):
        ...
        ax.bar(
            cell_proportions.index,
            cell_proportions.values,
            color=sns.color_palette("husl", len(cell_proportions)),
        )
...
def show_cell_type_proportions(viewer, assignments):
    ...
    viewer.window.add_dock_widget(
        CellProportionWidget(assignments), name="cell type proportions"
    )
